...
for f in $FILES
    do
        ...
        # Print error message if incorrect usage (file I/O version of the script, only);
        # i.e., input and/or output file not specified.
        ...
        #$ f=input/chunk_test_input2.txt
        #$ echo $f
        #input/chunk_test_input2.txt
        # http://pubs.opengroup.org/onlinepubs/007908799/xcu/basename.html
        #$ basename $f
        #chunk_test_input2.txt
